;;; tangomod-theme.el --- Tango-based custom theme for faces
...
(let ((class '((class color) (min-colors 89)))
      ...
      (alum-1 "#ffffff") (alum-2 "#d3d7cf") (alum-3 "#babdb6")
      (alum-4 "#888a85") (alum-5 "#5f615c") (alum-6 "#000000")
  ...
  (custom-theme-set-faces
   ...
   ;; Highlighting faces
   `(fringe ((,class (:background "#FFFFFF")))) ;; EDITED
   `(highlight ((,class (:foreground ,alum-6 :background ,butter-2))))
   ;; Disabled for talk at PL offsite
