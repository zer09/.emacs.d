...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Font lock faces
   `(font-lock-builtin-face ((,class (:foreground ,cham-3))))
   `(font-lock-comment-face ((,class (:slant italic :foreground ,alum-3))))
   ;; `(font-lock-comment-face ((,class (:foreground ,cham-2))))
   `(font-lock-constant-face ((,class (:weight bold :foreground ,plum-0))))
...
;;; tangomod-dark-theme.el ends here
